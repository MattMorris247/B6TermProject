        ...
        {movieChunk.map(movie => (
          <div key={movie.id} className="movie-card">
            ...
            <div className='button-wrapper'>
              {movie.nowShowing && <button class="bg-white text-black"><Link to="/booktickets">Book Now</Link></button>}
              <button class="bg-white text-black"   onClick={() => window.open(movie.trailerUrl)}>Trailer</button>
            </div>
          </div>
        ))}
      </div>
