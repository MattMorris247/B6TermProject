        ...
        <div className="row">
            ...
            <div className="column-main">
                ...
                <form>
                    ...
                    <h1 class="font-bold text-2xl ml-60 mt-4 text-white mt-14">User Information</h1>
                    ...
                    <h1 class="font-bold text-2xl ml-60 mt-4 text-white">Payment Info</h1>
                ...
                <label class="font-bold text-1xl ml-32 mt-4 mb-14 text-white">Do you want to be signed up for email promotions?
                <input class="ml-1"
                id="promotions"
                type="checkbox"/>
                </label>
